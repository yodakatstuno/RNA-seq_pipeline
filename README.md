...
```bash
git clone https://github.com/<your-username>/RNA-seq2.git
cd RNA-seq2
docker pull ghcr.io/<your-username>/rnaseq-pipeline:v1.0.0
docker tag ghcr.io/<your-username>/rnaseq-pipeline:v1.0.0 rnaseq-pipeline:v1.0.0
docker run --rm rnaseq-pipeline:v1.0.0 --help
docker run --rm rnaseq-pipeline:v1.0.0 --example --organism zebrafish --run 1 --non-interactive
```
